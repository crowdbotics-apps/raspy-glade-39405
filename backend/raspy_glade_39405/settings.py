"""
Django settings for raspy_glade_39405 project.
...
ROOT_URLCONF = 'raspy_glade_39405.urls'
...
WSGI_APPLICATION = 'raspy_glade_39405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_glade_39405 API",
    "DESCRIPTION": "API documentation for raspy_glade_39405 App",
    "VERSION": "v1",
}
